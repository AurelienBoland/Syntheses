...
L'action prédictive (ou commande anticipatrice) n'est pas applicable si $G(s)$ est à non minimum de phase, car le compensateur $C_1(s)$ aurait alors un pôle instable. De plus, si $G(s)$ possède un retard, l'action prédictive est irréalisable.
